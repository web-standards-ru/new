---
title: "Советы по обеспечению доступности интерактивных элементов на мобильных устройствах"
date: "2019-02-21"
---
...
<figure>
    ...
    <img src="images/6.png" alt="Появление лоудера вверху ленты.">
	<figcaption><em>При прокручивании вверх страницы профиля в мобильном Твиттере, появляется иконка «потянуть чтобы обновить»</em></figcaption>
</figure>
...
1. Увеличивается количество элементов, по которым придётся проходить пользователю при навигации с клавиатуры. Если перемещаться по странице при помощи таба, то подобное дублирование может утомить.
...
![[Ире Адеринокун.](https://bitsofco.de/)](images/8.png)_[Ире Адеринокун.](https://bitsofco.de/)_
