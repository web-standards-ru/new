...
![Нажать кнопку, получить бекон — это же очевидно.](images/1.png)
*Нажать кнопку, получить бекон — это же очевидно.*
...
![Что вы сделаете в первую очередь, если увидите, что кто-то тонет? LOL.](images/2.jpeg)
*Что вы сделаете в первую очередь, если увидите, что кто-то тонет? LOL.*
