...
![*Обычная загрузка в head*](images/1.gif)
Обычная загрузка в head

![Critical CSS](images/2.gif)
Critical CSS
...
![PageSpeed: 74 балла из 100.](images/4.jpg)
PageSpeed: 74 балла из 100.
...
![PageSpeed: 98 баллов из 100.](images/5.jpg)
PageSpeed: 98 баллов из 100.
...
![Сравнение подходов к загрузке на WebPageTest.](images/6.jpg)
Сравнение подходов к загрузке на WebPageTest.
