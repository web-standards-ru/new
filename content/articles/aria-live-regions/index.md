...
* Если у вас на странице есть часть, содержимое которой изменяется, то нужно сделать её live region. Тогда скринридеры смогут держать своих пользователей в курсе всех изменений. Сделать такую часть интерактивной можно с помощью role="alert", role="status", role="log", role="marquee", role="timer" и атрибута aria-live.
...
*Редактура [Вадима Макеева](https://medium.com/@pepelsbey).*
