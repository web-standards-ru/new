...
Уже не первый год мы в «[Студии 15](http://www.15web.ru/)» занимаемся доступностью сайтов для людей с ограниченными возможностями. Чтобы делать эту работу качественнее и быстрее разрабатываем опенсорсную [библиотеку интерфейсных решений](https://github.com/15web/web-accessibility).
...
<figure>
    <img src="images/1.jpg" alt="Популярные программы для чтения с экрана.">
...
<figure>
    <img src="images/2.jpg" alt="Распространенные проблемы на сайтах.">
    <figcaption>Распространенные проблемы на сайтах.</figcaption>
</figure>

Распространенные проблемы на сайтах
